...
// グループの作成
  createGroup:async({group_icon,group_name,group_description}:createGroupData)=>{
...
// アクティブなグループデータを取得
  ...
  //グループデータの更新
  updateGroupData:async(req:Request,{groupIdInt,group_name,group_description}:UpdateGroupDataType)=>{
